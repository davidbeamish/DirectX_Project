...
PixelInputType FireVertexShader(VertexInputType input)
{
	...
	output.texCoords1.x = output.texCoords1.x + (frameTime * scrollSpeeds.x);
	output.texCoords1.y = output.texCoords1.y + (frameTime * scrollSpeeds.x);
	//output.texCoords1.y = output.texCoords1.y + (-input.color.w * scrollSpeeds.x);
	...
	output.texCoords2.x = output.texCoords2.x + (frameTime * scrollSpeeds.y);
	output.texCoords2.y = output.texCoords2.y + (frameTime * scrollSpeeds.y);
	//output.texCoords2.y = output.texCoords2.y + (-input.color.w* scrollSpeeds.y);
	...
	output.texCoords3.x = output.texCoords3.x + (frameTime * scrollSpeeds.z);
	output.texCoords3.y = output.texCoords3.y + (frameTime * scrollSpeeds.z);
	//output.texCoords3.y = output.texCoords3.y + (-input.color.w * scrollSpeeds.z);
