...
PixelInputType ConvolutionVertexShader(VertexInputType input)
{
	...
	output.texCoord2 = input.tex + float2(texelSize *  0.0f, texelSize * -1.0f);
	output.texCoord3 = input.tex + float2(texelSize *  1.0f, texelSize * -1.0f);

	output.texCoord4 = input.tex + float2(texelSize * -1.0f, texelSize * 0.0f);
	output.texCoord5 = input.tex + float2(texelSize *  0.0f, texelSize * 0.0f);
	output.texCoord6 = input.tex + float2(texelSize *  1.0f, texelSize * 0.0f);	

	output.texCoord7 = input.tex + float2(texelSize * -1.0f, texelSize * 1.0f);
	output.texCoord8 = input.tex + float2(texelSize *  0.0f, texelSize * 1.0f);
