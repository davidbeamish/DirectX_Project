...
bool SkyDome::Initialize(ID3D11Device* device, char* modelFilename)
{
	bool result;


	// Load in the sky dome model.
	result = LoadSkyDomeModel(modelFilename);
	if(!result)
	{
		return false;
	}
	...
	//sky blue = (135.0f /255.0f, 206.0f / 255.0f, 235 / 255.0f, 0.1f)
	//light sky blue = (135.0f / 255.0f, 196.0f / 255.0f, 250.0f / 255.0f, 0.1f)
	//Steel blue = (70.0f / 255.0f, 130.0f / 255.0f, 180.0f / 255.0f, 0.1f)
	//UN blue = (91.0f / 255.0f, 146.0f / 255.0f, 229.0f / 255.0f, 0.1f)
	//Royal blue = (65.0f / 255.0f, 105.0f / 255.0f, 225.0f / 255.0f, 0.1f)
	// Set the color at the top of the sky dome.
	m_centerColor= D3DXVECTOR4(91.0f / 255.0f, 146.0f / 255.0f, 229.0f / 255.0f, 0.1f);
	// Hot pink (255.0f / 255.0f, 105.0f / 255.0f, 180.0f / 255.0f, 0.1f)
	// Set the color at the center of the sky dome.
	
	m_apexColor =  D3DXVECTOR4(65.0f / 255.0f, 105.0f / 255.0f, 225.0f / 255.0f, 0.1f);
...
bool SkyDome::LoadSkyDomeModel(char* modelFilename)
{
	ifstream fin;
	char input;
	int i;
