...
bool Bitmap::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, WCHAR* textureFilename1, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
//ID3D11ShaderResourceView** Bitmap::GetTextureArray()
//{
...
//bool Bitmap::LoadTextures(ID3D11Device* device, WCHAR* filename1, WCHAR* filename2)
//{
//	bool result;
//
//
