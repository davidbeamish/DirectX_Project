////////////////////////////////////////////////////////////////////////////////
// Filename: terrainreflectionshader.cpp
...
TerrainReflectionShader::TerrainReflectionShader(const TerrainReflectionShader& other)
{
}
...
bool TerrainReflectionShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"../Engine/terrainreflection.vs", L"../Engine/terrainreflection.ps");
	if(!result)
	{
		return false;
	}
...
void TerrainReflectionShader::Shutdown()
{
...
bool TerrainReflectionShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
...
bool TerrainReflectionShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void TerrainReflectionShader::ShutdownShader()
{
...
void TerrainReflectionShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool TerrainReflectionShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
...
void TerrainReflectionShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
