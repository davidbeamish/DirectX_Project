...
ObjectCursor::ObjectCursor(D3D* m_D3D, int screenWidth, int screenHeight, WCHAR* textureFilename1, int bitmapWidth, int bitmapHeight, int positionX, int positionY, D3DXMATRIX viewMatrix)
{
...
ObjectCursor::ObjectCursor(const ObjectCursor& other)
{
}
...
bool ObjectCursor::Render(GraphicsManager& graphicsmanager, int renderPass)
{
...
void ObjectCursor::SetPosition(int posX, int posY)
{
	m_positionX = posX;
	m_positionY = posY;
}
